...
require (
	github.com/Azure/ARO-Tools/config v0.0.0-20260511225500-2009d9b0e055 // indirect
	github.com/Azure/ARO-Tools/testutil v0.0.0-20260511225500-2009d9b0e055 // indirect
